...
export default function Feature_2() {
  return (
	...
	<div className="container p-4 mx-auto my-6 space-y-1 text-center">
		<span className="text-xs font-semibold tracking-wider uppercase dark:text-default-600">shortcut to your dream ui</span>
	...
	<div className="container grid justify-center gap-4 mx-auto lg:grid-cols-2 xl:grid-cols-4">
		<div className="flex flex-col px-8 py-6">
			...
			<a className="inline-flex items-center space-x-2 text-sm dark:text-default-600" href="/components">
		...
		<div className="flex flex-col px-8 py-6 lg:border-none xl:border-solid">
			...
			<a className="inline-flex items-center space-x-2 text-sm dark:text-default-600" href="/sections">
				<span>Learn More</span>
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
					<path fillRule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd"></path>
				</svg>
		...
		<div className="flex flex-col px-8 py-6">
			...
			<a className="inline-flex items-center space-x-2 text-sm dark:text-default-600" href="/templates">
				<span>Learn More</span>
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
					<path fillRule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd"></path>
				</svg>
		...
		<div className="flex flex-col px-8 py-6">
			...
			<a className="inline-flex items-center space-x-2 text-sm dark:text-default-600" href="/docs">
				<span>Learn More</span>
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
					<path fillRule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd"></path>
				</svg>
