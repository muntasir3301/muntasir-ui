...
export default function Testimonial_1() {
  return (
	...
	<div className="container flex flex-col items-center p-4 mx-auto space-y-6 md:p-8">
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="w-16 h-16 dark:text-default-600">
		...
		<div className="flex justify-center space-x-3">
			<Image width={100} height={100} src="https://source.unsplash.com/80x80/?portrait?1" alt="" className="w-20 h-20 bg-center bg-cover rounded-md dark:bg-gray-500" />
			<div>
				<p className="leading-tight">Leroy Jenkins</p>
				<p className="text-sm leading-tight dark:text-gray-700">Founder, Company</p>
				<button className="flex items-center py-2 space-x-1 text-sm dark:text-default-600" href="/">
